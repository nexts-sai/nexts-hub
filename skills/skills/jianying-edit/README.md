...
本目录基于 [yichen-jianying-edit](https://github.com/mcncarl/yichen-skills/tree/main/yichen-jianying-edit)
改名整理，保留原作者的 [许可证](LICENSE) 和
[依赖及来源声明](references/dependencies-and-notices.md)。核心项目继续保持私有；
Skill 文件齐全不代表无需核心访问权限即可运行。本副本不应在未获得原作者书面许可前公开发布。
...
```bash
python3 /absolute/path/to/jianying-edit/scripts/headless_draft.py doctor
```
